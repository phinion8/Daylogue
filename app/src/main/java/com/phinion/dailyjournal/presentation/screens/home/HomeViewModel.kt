...
import com.phinion.dailyjournal.connectivity.ConnectivityObserver
import com.phinion.dailyjournal.connectivity.NetworkConnectivityObserver
...
class HomeViewModel @Inject constructor(
    ...
    //whenever our network changes our network variable will be updated
    ...
    fun deleteDiaries(
        ...
        if (network == ConnectivityObserver.Status.Available) {
            ...
            //the directory where we have placed the images of the user
